    ...
    return (
        <section ref={sectionRef} className={'relative h-[90vh] md:h-screen flex overflow-hidden w-full bg-primary'}>
            ...
            <a
                ...
                className={`${showSkip ? 'md:opacity-100' : 'md:opacity-0'} hover:bg-[#FFFFFF80] hover:bottom-20 hover:no-underline group hover:border-primary transition-all duration-150 absolute text-xl bottom-20 translate-x-[50%] right-[50%] flex cursor-pointer items-center px-4 rounded-2xl border-2`}>
